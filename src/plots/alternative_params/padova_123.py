...
This one plots a padova track with class 1, 2, 3 clusters only.
"""
# libraries
import numpy as np
...
if reRun:
    ...
    np.save(path2save+"PadKroupc123LHa_QH0_noCons.npy", clusterdata)
   
# If user chooses not to rerun the analysis and use pre-run data,
elif not reRun:
    clusterdata = np.load(path2save+"PadKroupc123LHa_QH0_noCons.npy", allow_pickle = True)
...
plot_tools.save("PadKroupc123Fesc")
...
plot_tools.save("PadKroupc123Fesc_Bayesian")
