...
# --- figure theme: "default" (published) or "poster" ---
THEME = "default"
_poster = THEME == "poster"
_THEME = {
    "default": dict(figsize=(6, 5), xlim=(46, 52), ylim=(35.4, 39.4),
                    legend_face=None, suffix=""),
    "poster": dict(figsize=(6, 6), xlim=(47.5, 52), ylim=(36.4, 39.4),
                   legend_face="none", suffix="_poster"),
}[THEME]
...
# Plot 
# =============================================================================
fig, ax =  plt.subplots(1,1, figsize = _THEME["figsize"], dpi = 300)
...
plt.legend(loc = 'lower right', 
           facecolor = _THEME["legend_face"],
           fontsize = 9,
           labelspacing = .5,
           frameon = True)

plot_tools.save("GenKroupc1234LHa_QH0_wCons" + _THEME["suffix"])
