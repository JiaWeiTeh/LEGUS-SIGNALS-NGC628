...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb  7 16:28:10 2023

@author: Jia Wei Teh

This script plots selected line ratios for purpose of 
...
fig, axs =  plt.subplots(1,2, figsize = (6,3), dpi = 210)
...
for ii, idx in enumerate(range(int(len(emissions)/3))):
    ...
    axs[ax_idx_y].set_xlabel("$f_{\\rm esc}$")
    ...
    ax.text(0.30, 0.1, '$\\rho = %.2f, p = %.5f$'%(rho, pval), 
...
plot_tools.save("lineratios_specific_poster")
