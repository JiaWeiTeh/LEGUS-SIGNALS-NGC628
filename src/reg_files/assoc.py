...
This script saves associated h2 regions and clusters into .reg file
"""
...
# populated_h2regions_without_c4 = before adding Class 4
# populated_h2regions_with_c4 = after adding Class 4
with open(path2reg+"orphan_h2regions.reg","w+") as orphan_h2regions,\
     open(path2reg+"populated_h2regions.reg","w+") as populated_h2regions:
    ...
    for h2 in h2_catalogue:
        ...
        # returns True if list contains only Class 4
        isOrphan = all([read_catalogue.get_sc_param(sc, 'class') == 4 for sc in scIDlist])
        ...
        if isOrphan:
            ...
            dash = "dash=1"
            line = [shape, ra, dec, size, "#",colour, width, dashlist, dash, "\n"]
            line = " ".join(line)
            orphan_h2regions.write(line)
            ...
            line = " ".join(line)
            populated_h2regions.write(line)
        
# done
orphan_h2regions.close()
populated_h2regions.close()
